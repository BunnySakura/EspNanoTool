...
static int main_page_digital_clock_app_min_value = 23;
static int main_page_digital_clock_app_sec_value = 34;
const static lv_coord_t app_size = 60;

void main_page_digital_clock_app_timer(lv_timer_t *timer) {
  clock_count_24(&main_page_digital_clock_app_hour_value,
                 &main_page_digital_clock_app_min_value,
                 &main_page_digital_clock_app_sec_value);
  if (lv_obj_is_valid(guider_ui.main_page_digital_clock_app)) {
    lv_dclock_set_text_fmt(guider_ui.main_page_digital_clock_app,
                           "%02d:%02d:%02d",
                           main_page_digital_clock_app_hour_value,
                           main_page_digital_clock_app_min_value,
                           main_page_digital_clock_app_sec_value);
  }
}
static lv_obj_t *g_kb_main_page;
static void kb_main_page_event_cb(lv_event_t *e) {
...
__attribute__((unused)) static void ta_main_page_event_cb(lv_event_t *e) {
...
void setup_scr_main_page(lv_ui *ui) {
  ...
  //Create keyboard on main_page
  g_kb_main_page = lv_keyboard_create(ui->main_page);
  lv_obj_add_event_cb(g_kb_main_page, kb_main_page_event_cb, LV_EVENT_ALL, NULL);
  lv_obj_add_flag(g_kb_main_page, LV_OBJ_FLAG_HIDDEN);
  lv_obj_set_style_text_font(g_kb_main_page, &lv_font_simsun_18, LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_size(ui->main_page_app_list, lv_disp_get_hor_res(NULL), lv_disp_get_ver_res(NULL));
  lv_obj_set_scrollbar_mode(ui->main_page_app_list, LV_SCROLLBAR_MODE_OFF);
  lv_carousel_set_element_width(ui->main_page_app_list, lv_disp_get_hor_res(NULL));
  ...
  lv_obj_set_style_bg_grad_color(ui->main_page_app_list,
  ...
  lv_obj_set_style_shadow_color(ui->main_page_app_list,
                                lv_color_make(0xff, 0xff, 0xff),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui->main_page_app_list,
  ...
  lv_obj_set_pos(
      ...
      (lv_coord_t) ((lv_disp_get_hor_res(NULL) - app_size) / 2),
      (lv_coord_t) ((lv_disp_get_ver_res(NULL) - app_size) / 2)
  );
  lv_obj_set_size(ui->main_page_setting_app, app_size, app_size);
  ...
  lv_obj_set_style_shadow_color(ui->main_page_setting_app,
  ...
  lv_obj_set_size(ui->main_page_uart_chart_app, app_size, app_size);
  ...
  lv_obj_set_style_shadow_color(ui->main_page_uart_chart_app,
                                lv_color_make(0x21, 0x95, 0xf6),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui->main_page_uart_chart_app,
                              lv_color_make(0x00, 0x00, 0x00),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_align(ui->main_page_uart_chart_app, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_img_recolor(ui->main_page_uart_chart_app,
                               lv_color_make(0xff, 0xff, 0xff),
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  ui->main_page_digital_clock_app = lv_dclock_create(ui->app_1, "12:23:34");
  ...
  lv_obj_set_size(ui->main_page_digital_clock_app, lv_disp_get_hor_res(NULL), lv_disp_get_ver_res(NULL));
  ...
  lv_obj_set_style_bg_color(ui->main_page_digital_clock_app,
                            lv_color_make(0x2F, 0xDA, 0x64),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_grad_color(ui->main_page_digital_clock_app,
  ...
  lv_obj_set_style_shadow_color(ui->main_page_digital_clock_app,
                                lv_color_make(0x21, 0x95, 0xf6),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui->main_page_digital_clock_app,
                              lv_color_make(0xff, 0xff, 0xff),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui->main_page_digital_clock_app,
                             &lv_font_montserratMedium_32,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_letter_space(ui->main_page_digital_clock_app, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_pad_top(ui->main_page_digital_clock_app, 25, LV_PART_MAIN | LV_STATE_DEFAULT);
